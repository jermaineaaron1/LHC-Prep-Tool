    ...
    <div className="max-w-2xl mx-auto p-8">
      ...
      {songs.length === 0 && (
        <div className="text-gray-500 text-center py-16">
          ...
          <a href="/practice-game/library" className="text-emerald-400 hover:underline text-sm mt-2 block">
...
function LobbyScreen({
  ...
  const phoneUrl = typeof window !== 'undefined'
    ? `${window.location.origin}/practice-game/phone?room=${session.room_code}`
    : '';
