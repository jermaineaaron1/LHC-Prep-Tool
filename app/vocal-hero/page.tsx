...
function SoloReviewStage({ song, part, score, review, warmUp, onDone }: {
  song: Song; part: number; score: number; review: RoundReview; warmUp: boolean; onDone: () => void;
}) {
  return <section className="mx-auto max-w-[900px] px-5 py-10">
    <div className="vh-panel p-6">
      ...
      {!warmUp && <div className="mt-4"><HighScoreBoard songId={song.id} highlight={['Solo Singer']} /></div>}
