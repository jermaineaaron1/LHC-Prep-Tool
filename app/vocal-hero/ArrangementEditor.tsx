      ...
      <main className="flex min-w-0 flex-1 flex-col overflow-hidden bg-[radial-gradient(circle_at_50%_0%,#28135055,transparent_30%),#080b1c]">
        ...
        <div className="flex min-h-0 flex-1">
          <section className={`flex min-w-0 flex-1 flex-col overflow-auto [&>*]:shrink-0 ${timelineFocus ? 'p-1' : 'p-3'}`}>
            ...
            <div className="mb-2 flex flex-wrap items-center gap-2 text-[11px] text-slate-400"><button onClick={() => setCollapsedVoices([true, true, true, true])} className="rounded-md border border-white/10 px-2 py-1 text-slate-300">Collapse all voices</button><button onClick={() => setCollapsedVoices([false, false, false, false])} className="rounded-md border border-white/10 px-2 py-1 text-slate-300">Expand all voices</button></div></>}
