...
function PhoneGame() {
  ...
  const [audioBlocked, setAudioBlocked] = useState(false); const [score, setScore] = useState(0); const [hits, setHits] = useState<Record<string, boolean>>({}); const [fullBoard, setFullBoard] = useState(false); const [pausedElapsed, setPausedElapsed] = useState(0);
