...
function PhoneGame() {
  ...
  // the engine.
  const [diag, setDiag] = useState({ hz: 0, level: 0, confidence: 0, rate: 0, dc: 0 }); const [score, setScore] = useState(0); const [hits, setHits] = useState<Record<string, boolean>>({}); const [fullBoard, setFullBoard] = useState(false); const [pausedElapsed, setPausedElapsed] = useState(0);
