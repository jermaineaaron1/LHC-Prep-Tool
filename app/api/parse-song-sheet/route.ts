...
export async function POST(req: NextRequest) {
  try {
    ...
    const promptText = [
      ...
      '',
      'If the sheet is a music score with no printed chord symbols, set chordsFound',
      'to false and return the lyrics WITHOUT any chord lines. Rejoin words split',
      'across notes by hyphens ("A- ma- zing" becomes "Amazing"). Do not derive',
      'chords from the notes on the staves.',
      '',
