...
## 2026-08-10 — Share-image sharpness fix: 3x-scale the card CSS instead of relying on CloudConvert `zoom` (branch `feature/premium-mobile-roster`, committed locally, not yet pushed)
