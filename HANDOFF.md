...
## 2026-08-10 — Whole-month view follow-ups: tab labels, subtitle fix, per-card WhatsApp picture share (branch `feature/premium-mobile-roster`, not yet pushed)

Small follow-up round on top of the already-merged premium mobile roster redesign (see the 2026-08-09 entry below — that work is live in production as of merge commit `a0e5ef0`; this is new work on the same branch, committed locally only so far). Requested via an annotated screenshot of the live production view.
