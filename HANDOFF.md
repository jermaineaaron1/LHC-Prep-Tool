...
- Arrangement editor lane range selection: a drag selection now records the SATB lane it began in. Only that lane receives the range highlight, its notes enter the selection, and playback scopes to that voice; the operation no longer highlights or auditions the full SATB arrangement.
