...
## 2026-08-10 — Whole Month table readability pass: thick gridlines, smaller options icon, smaller service-type badges, bigger centered date badge (branch `feature/premium-mobile-roster`, committed locally, not yet pushed)
